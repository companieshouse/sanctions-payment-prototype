...
// Add your routes here
  ...
  // ******* filter-question ********************************
  router.get('/v5/filter-question', function (req, res) {
    // Set URl
    res.render('v5/filter-question', {
  ...
  router.post('/v5/filter-question', function (req, res) {
    // Create empty array
    var errors = []
      ...
      res.render('v5/filter-question', {
        ...
        errorList: errors
          ...
          if (req.session.data['applyToYou'] == 'none') {   // this was === which doesn't work, changing to == seems to work?!
            ...
            res.redirect('/v5/stop-you-need-to-pay-another-way')
          }
    }
  })
    ...
    // router.post('/v5/penalty-details', function (req, res) {
    //   // Create empty array
    //   var errors = []
    ...
    //     // Re-show page with error value as true so errors will show
    //     res.render('v5/penalty-details', {
    //       errorPenaltyReference: true,
    //       errorList: errors
    //     })           
    //   } else {
    //       // If selected goes to next page
    //       res.redirect('/v5/penalty-summary')
    //     }           
    //   })
